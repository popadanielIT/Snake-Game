...
inputText.addEventListener("keyup", (e) => {
    if (e.keyCode === 13){
      scoreTxt.innerHTML += capitalizeFirstLetter(e.target.value) + " / Score: " + score + "<br>";
...
function displayGameOverOrWin(){
    if(score == "50"){
        ctx.font = "50px MV Boli";
        ctx.fillStyle = "black";
        ctx.textAlign = "center";
        ctx.fillText("You Win The Game!", gameWidth / 2, 50);
        running = false;
    }else{
    ctx.font = "50px MV Boli";
    ctx.fillStyle = "black";
    ctx.textAlign = "center";
    ctx.fillText("Game Over!", gameWidth / 2, 50);
    running = false;
    }
